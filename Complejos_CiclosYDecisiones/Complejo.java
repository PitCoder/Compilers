public class Complejo {
  ...
  public boolean equals(Complejo c1, Complejo c2) {
    Complejo res = restaComplejos(c1, c2);
    return res.getReal() == 0 && res.getImg() == 0;
  }
  
  public boolean greaterThan(Complejo c1, Complejo c2) {
    /* The comparison is between real part of both complex numbers */
    return restaComplejos(c1, c2).getReal() > 0;
  }
  
  public boolean greaterOrEqualsThan(Complejo c1, Complejo c2) {
    /* The comparison is between real part of both complex numbers */
    return restaComplejos(c1, c2).getReal() >= 0;
  }
  
  public boolean lessThan(Complejo c1, Complejo c2) {
    /* The comparison is between real part of both complex numbers */
    return restaComplejos(c1, c2).getReal() < 0;
  }
  
  public boolean lessOrEqualsThan(Complejo c1, Complejo c2) {
    /* The comparison is between real part of both complex numbers */
    return restaComplejos(c1, c2).getReal() <= 0;
  }
