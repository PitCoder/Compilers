...
stmt : expr ';' { System.out.println("Expr Statement"); }
     ...
     | for '(' initstmt ':' testexpr ':' updatestmt ')' stmt end {
       machine.getProgram().setElementAt($3.obj,  (int) $1.obj + 1);
       machine.getProgram().setElementAt($5.obj,  (int) $1.obj + 2);
       machine.getProgram().setElementAt($7.obj,  (int) $1.obj + 3);
       machine.getProgram().setElementAt($9.obj,  (int) $1.obj + 4);
       machine.getProgram().setElementAt($10.obj, (int) $1.obj + 5);
}
     | '{' stmtlist '}' {
  $$ = $2;
}
